      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-12 max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-semibold mb-2 text-gray-900">Build Your Credit Score</h3>
                <p className="text-gray-600 text-sm">Many landlords check credit scores. Start building credit early.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-semibold mb-2 text-gray-900">Save for Security Deposit</h3>
                <p className="text-gray-600 text-sm">Budget to have 2-3 months rent saved before moving.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-semibold mb-2 text-gray-900">Consider Roommates</h3>
                <p className="text-gray-600 text-sm">Splitting rent can significantly reduce your housing costs.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="font-semibold mb-2 text-gray-900">Factor in All Costs</h3>
          ...
          <div className="mt-8 bg-blue-50 rounded-lg p-6 max-w-4xl mx-auto">
            <h3 className="font-semibold mb-2 text-gray-900">What is the 30% Rule?</h3>
